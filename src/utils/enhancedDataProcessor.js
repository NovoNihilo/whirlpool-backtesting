...
// COMPATIBILITY LAYER FOR ORIGINAL FUNCTIONS
// These functions provide compatibility with the original data processor
...
export const generateSummaryStats = (performanceData) => {
  ...
  return {
    ...
    maxDrawdown: {
      strategy1: 0, // Added for compatibility
      strategy2: 0, // Added for compatibility
      strategy3: 0, // Added for compatibility
    },
    sharpeRatio: {
      strategy1: 0, // Added for compatibility
      strategy2: 0, // Added for compatibility
